...
class RoomExchangeRecord(models.Model):
  ...
  old_room = models.ForeignKey(Room, on_delete=models.CASCADE, related_name="old_room")
  new_room = models.ForeignKey(Room, on_delete=models.CASCADE, blank=True, null=True, related_name="new_room")
